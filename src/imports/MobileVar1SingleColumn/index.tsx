...
import imgImage3 from "./6f13b43bff73692f3535ad9ee71e65d34379edcf.png";
import img161 from "./146d43f51e15479edc5b6567ca17c752c93c098a.png";
import imgMpobileBackground1 from "./78df30dacbd58b5f9311c19c19ed2cc1e568dbfb.png";
import imgSonsonateIlustration23 from "./a846ec44cc9d1a94bdbcbeb391dfc00b91a5018a.png";
import imgNahuzalcoIllustratyion23 from "./f5b5961e54952719ffe5e43d303abb6cd7bd7565.png";
import imgJuayua23 from "./dbb8d5036dc30326df8b5297904a5b53b0cfb5f8.png";
...
function Text() {
  return <div className="bg-[#1c2420] h-[1.499px] relative rounded-[17500500px] shrink-0 w-[24px]" data-name="Text" />;
}

function Text1() {
  return <div className="bg-[#1c2420] h-px relative rounded-[17500500px] shrink-0 w-[24px]" data-name="Text" />;
}
...
function ButtonOpenMenu() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] items-center justify-center relative shrink-0 size-[39.997px]" data-name="Button - Open menu">
      <Text />
      <Text1 />
      <Text2 />
    </div>
...
function Icon() {
  return (
    <div className="absolute left-0 size-[21.995px] top-0" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="21.995" preserveAspectRatio="none" viewBox="0 0 21.995 21.995" width="21.995">
        <g clipPath="url(#clip0_0_76)" id="Icon">
          <path d={svgPaths.p15776900} fill="white" id="Vector" />
        </g>
        <defs>
          <clipPath id="clip0_0_76">
            <rect fill="white" height="21.995" width="21.995" />
          </clipPath>
        </defs>
      </svg>
    </div>
...
function Container2() {
  return (
    <div className="relative shrink-0 size-[21.995px]" data-name="Container">
      <Icon />
    </div>
  );
}
...
function Container1() {
  return (
    <div className="bg-[#3d9e72] content-stretch flex items-center px-[20px] py-[10px] relative rounded-[4px] shrink-0" data-name="Container">
      <Container2 />
    </div>
  );
}
...
function Container() {
  return (
    <div className="content-stretch flex items-center justify-end relative shrink-0 w-[322.647px]" data-name="Container">
      <Container1 />
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[135.32px] top-[18.99px] w-[132px]" data-name="Paragraph">
...
function NavBar() {
  return (
    <div className="content-stretch flex h-[71.999px] items-center justify-between px-[20px] relative shrink-0 w-full" data-name="NavBar">
      <ButtonOpenMenu />
      <Container />
      <Paragraph />
    </div>
...
function App() {
  return (
    <div className="bg-[#f2f4f3] content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="App">
      <div aria-hidden className="absolute border-[rgba(28,36,32,0.09)] border-b-[0.522px] border-solid inset-0 pointer-events-none" />
      <NavBar />
    </div>
  );
}
      ...
      <div className="bg-[#3d9e72] drop-shadow-[0px_4px_6px_rgba(61,158,114,0.3)] relative shrink-0 w-full" data-name="V2 / Primary Button">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="[word-break:break-word] content-stretch flex gap-[8px] items-center justify-center leading-[normal] px-[28px] py-[14px] relative size-full text-white whitespace-nowrap">
            <p className="font-['Nunito:ExtraBold',sans-serif] font-extrabold relative shrink-0 text-[14px] tracking-[0.5px]">Our Story</p>
...
function Frame4() {
  return (
    <div className="[word-break:break-word] content-stretch flex gap-[12px] items-center leading-[normal] relative shrink-0 whitespace-nowrap" data-name="Frame">
      <p className="font-['Fraunces:Bold','Noto_Sans:Bold','Noto_Sans_Math:Regular','Noto_Sans_Symbols:Bold','Noto_Sans_Symbols2:Regular',sans-serif] font-bold relative shrink-0 text-[#f2b138] text-[20px]" style={{ fontVariationSettings: '"SOFT" 0, "WONK" 1' }}>
        ★ 4.9
      </p>
      <p className="font-['DM_Sans:Regular',sans-serif] font-normal opacity-65 relative shrink-0 text-[#ede8d8] text-[10px] tracking-[1px]" style={{ fontVariationSettings: '"opsz" 14' }}>
        booking raiting
      </p>
    </div>
  );
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center pt-[12px] relative shrink-0 w-full" data-name="Frame">
      <Frame4 />
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="bg-[#0c1a10] relative shrink-0 w-full" data-name="Frame">
      <div className="content-stretch flex flex-col gap-[20px] items-start p-[24px] relative size-full">
        <p className="[word-break:break-word] font-['Fraunces:Black_Italic',sans-serif] font-black italic leading-[normal] relative shrink-0 text-[#f2b138] text-[38px] w-full" style={{ fontVariationSettings: '"SOFT" 0, "WONK" 1' }}>
          Neskapolita
        </p>
        <p className="[word-break:break-word] font-['Fraunces:Black',sans-serif] font-black leading-[normal] relative shrink-0 text-[#ede8d8] text-[24px] text-center w-full" style={{ fontVariationSettings: '"SOFT" 0, "WONK" 1' }}>
...
function Frame() {
  return (
    <div className="bg-[#0c1a10] content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Frame">
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Frame">
      <p className="[word-break:break-word] font-['Fraunces:Black',sans-serif] font-black leading-[0] relative shrink-0 text-[#4c6e58] text-[20px] text-center w-full whitespace-pre-wrap" style={{ fontVariationSettings: '"SOFT" 0, "WONK" 1' }}>
        <span className="leading-[normal] text-[#0a1209]">{`Neskapolita:  The Story of the`}</span>
        <span className="leading-[normal]">
          <br aria-hidden />
          {` `}
        </span>
        <span className="leading-[normal] text-[#3d9e72]">{`"Pretty Girl"`}</span>
      </p>
    </div>
  );
}
...
function TitlePhoto() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center justify-center relative shrink-0 w-full" data-name="title + photo">
      <div className="relative rounded-[59px] shrink-0 size-[118px]" data-name="Rectangle">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[59px] size-full" src={imgRectangle1} />
      </div>
      <Frame6 />
    </div>
  );
...
function Content() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-center left-[20px] top-[50px] w-[353px]" data-name="content">
      <TitlePhoto />
      <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] font-normal leading-[20px] min-w-full relative shrink-0 text-[#1c2420] text-[13px] text-center w-[min-content]" style={{ fontVariationSettings: '"opsz" 14' }}>
        Step inside the family home that inspired a legacy of hospitality.
      </p>
      <div className="relative rounded-[4px] shrink-0 w-[272px]" data-name="V3 / Secondary Button">
...
function Frame5() {
  return (
    <div className="bg-[#f2f4f3] h-[400px] overflow-clip relative shrink-0 w-full" data-name="Frame">
      <div className="absolute h-[442px] left-[-24px] top-0 w-[887px]" data-name="bg-simple-flowers 1">
...
function Frame8() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Frame">
      <p className="font-['Fraunces:Black',sans-serif] font-black leading-[0] relative shrink-0 text-[#1c2420] text-[24px] whitespace-nowrap" style={{ fontVariationSettings: '"SOFT" 0, "WONK" 1' }}>
        <span className="leading-[normal]">{`Find Your `}</span>
        <span className="leading-[normal] text-[#4c6e58]">Casa</span>
      </p>
      <p className="font-['DM_Sans:Regular',sans-serif] font-normal leading-[20px] min-w-full relative shrink-0 text-[#54625d] text-[14px] w-[min-content]" style={{ fontVariationSettings: '"opsz" 14' }}>
  ...
  return (
    <div className="relative shrink-0 size-[15.154px]" data-name="Shower">
      <svg className="absolute block inset-0 size-full" fill="none" height="15.1543" preserveAspectRatio="none" viewBox="0 0 15.1543 15.1543" width="15.1543">
        <g clipPath="url(#clip0_0_72)" id="Shower">
...
function ActionRow() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Action Row">
      <Frame9 />
      <div className="bg-[#3d9e72] drop-shadow-[0px_4px_6px_rgba(61,158,114,0.3)] flex-[1_0_0] h-[36px] min-w-px relative" data-name="V2 / Primary Button">
        <div className="flex flex-row items-center justify-center size-full">
...
function Room3() {
  return (
    <div className="bg-white h-[300px] relative shrink-0 w-full" data-name="room01">
...
function Frame13() {
  return (
    <div className="bg-white h-[117px] relative shrink-0 w-full">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <div className="absolute h-[482px] left-[-8.72px] top-[-141.72px] w-[362px]" data-name="image">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage2} />
        </div>
        <div className="absolute bg-[rgba(12,26,16,0.4)] h-[312px] left-[0.28px] mix-blend-multiply top-[0.28px] w-[359px]" data-name="shadow" />
        <div className="absolute h-[56.344px] left-[13.28px] top-[10.28px] w-[53.698px]" data-name="02 1">
  ...
  return (
    <div className="bg-white h-[117px] relative shrink-0 w-full">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        ...
        <div className="absolute h-[494px] left-[-11.72px] top-[-84.72px] w-[371px]" data-name="image">
        ...
        <div className="absolute h-[53.045px] left-[9.28px] top-[13.28px] w-[53.698px]" data-name="16 1">
...
function Frame7() {
  return (
    <div className="bg-[#f2f4f3] relative shrink-0 w-full" data-name="Frame">
      <div className="content-stretch flex flex-col gap-[26px] items-start px-[16px] py-[40px] relative size-full">
        <Frame8 />
        <Room3 />
        <Room />
        <Room1 />
...
function Frame26() {
  return (
    <div className="bg-[#f2b138] content-stretch flex flex-col items-center justify-center relative rounded-[29px] shrink-0 size-[58px]" data-name="Frame">
...
function Frame28() {
  return (
    <div className="bg-[#4c6e58] relative rounded-[4px] shrink-0 w-full" data-name="Frame">
      <div className="flex flex-row justify-center size-full">
        <div className="content-stretch flex items-start justify-center px-[20px] py-[12px] relative size-full">
          <p className="[word-break:break-word] font-['DM_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[12px] text-white tracking-[1px] uppercase whitespace-nowrap" style={{ fontVariationSettings: '"opsz" 14' }}>
            Book Your Stay
          </p>
        </div>
      </div>
...
function MethodPayPal() {
  return (
    <div className="bg-[#f2f4f3] h-[68px] relative rounded-[8px] shrink-0 w-full" data-name="Method PayPal">
...
function MethodCash() {
  return (
    <div className="bg-[#f2f4f3] h-[68px] relative rounded-[8px] shrink-0 w-full" data-name="Method Cash">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[10px] items-center p-[16px] relative size-full">
          <Frame29 />
          <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#54625d] text-[9.6px] tracking-[0.96px] uppercase whitespace-nowrap" style={{ fontVariationSettings: '"opsz" 14' }}>
...
function MethodVisa() {
  return (
    <div className="bg-[#f2f4f3] h-[68px] relative rounded-[8px] shrink-0 w-full" data-name="Method Visa">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[10px] items-center p-[16px] relative size-full">
          <Container24 />
          <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#54625d] text-[9.6px] tracking-[0.96px] uppercase whitespace-nowrap" style={{ fontVariationSettings: '"opsz" 14' }}>
...
function PaymentMethodsRow() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="Payment Methods Row">
      <MethodPayPal />
      <MethodCash />
      <MethodVisa />
    </div>
...
function SecurityNote() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0 w-full" data-name="Security Note">
      <LockSimple />
      <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#18271c] text-[10.88px] text-center tracking-[0.65px] w-[225px] whitespace-pre-wrap" style={{ fontVariationSettings: '"opsz" 14' }}>
...
function RightColumn() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-center justify-end relative shrink-0 w-full" data-name="Right Column">
      <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] font-normal leading-[25.34px] relative shrink-0 text-[#1c2420] text-[14.08px] text-center w-full" style={{ fontVariationSettings: '"opsz" 14' }}>
...
function Frame25() {
  return (
    <div className="bg-[#ede8d8] relative shrink-0 w-full" data-name="Frame">
      <div className="content-stretch flex flex-col gap-[20px] items-start p-[24px] relative size-full">
        <Frame26 />
        <Frame27 />
        <Frame28 />
...
function CardGarden() {
  return (
    <div className="bg-white content-stretch drop-shadow-[0px_4px_6px_rgba(76,110,88,0.05)] flex flex-col gap-[16px] items-start px-[20px] py-[16px] relative rounded-[12px] shrink-0 w-[358px]" data-name="Card-Garden">
...
function Services() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0" data-name="services">
      <CardGarden />
      <CardGarden1 />
      <CardGarden2 />
      <CardGarden3 />
...
function Frame30() {
  return (
    <div className="relative shrink-0 w-full" data-name="Frame">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[24px] items-center justify-center px-[24px] py-[60px] relative size-full">
          <p className="[word-break:break-word] font-['Fraunces:Black',sans-serif] font-black leading-[34px] min-w-full relative shrink-0 text-[#1c2420] text-[28px] w-[min-content]" style={{ fontVariationSettings: '"SOFT" 0, "WONK" 1' }}>
...
function Flores() {
  return (
    <div className="h-[767px] relative shrink-0 w-[363.914px]" data-name="flores">
      <div className="absolute h-[767px] left-0 top-0 w-[363.914px]" data-name="mpobile-background 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgMpobileBackground1} />
      </div>
      <div className="absolute h-[98.911px] left-[114.14px] top-[606.1px] w-[148.367px]" data-name="sonsonate-ilustration2 3">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgSonsonateIlustration23} />
      </div>
      <div className="absolute h-[95.191px] left-[192.06px] top-[495.33px] w-[142.786px]" data-name="nahuzalco-illustratyion2 3">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgNahuzalcoIllustratyion23} />
      </div>
      <div className="absolute h-[105.44px] left-[48.44px] top-[390.03px] w-[158.16px]" data-name="juayua2 3">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgJuayua23} />
      </div>
      <div className="absolute h-[96.384px] left-[181.96px] top-[286.84px] w-[144.576px]" data-name="salcoatitan-ilustration2 3">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgSalcoatitanIlustration23} />
      </div>
      <div className="absolute h-[90.136px] left-[4.63px] top-[267.04px] w-[135.204px]" data-name="apaneca ilustration 2">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgApanecaIlustration2} />
      </div>
      <div className="absolute h-[103.965px] left-[114.14px] top-[144.05px] w-[155.948px]" data-name="ataco ilustration 2">
...
function ActionButton() {
  return (
    <div className="bg-[#3d9e72] content-stretch drop-shadow-[0px_6.698px_10.047px_rgba(76,110,88,0.05)] flex gap-[13.395px] items-center p-[20px] relative rounded-[6.698px] shrink-0" data-name="Action Button">
      <p className="[word-break:break-word] font-['DM_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[12px] text-white tracking-[2.2437px] uppercase w-[260px]" style={{ fontVariationSettings: '"opsz" 14' }}>
...
function Frame36() {
  return (
    <div className="bg-[#ede8d8] relative shrink-0 w-full" data-name="Frame">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[20px] items-center justify-center px-[24px] py-[40px] relative size-full">
          <p className="[word-break:break-word] font-['Fraunces:Black',sans-serif] font-black leading-[normal] relative shrink-0 text-[#1c2420] text-[24px] whitespace-nowrap" style={{ fontVariationSettings: '"SOFT" 0, "WONK" 1' }}>
            Ruta de las Flores
          </p>
          <Flores />
          <ActionButton />
...
export default function MobileVar1SingleColumn() {
  return (
    <div className="bg-[#f2f4f3] content-stretch flex flex-col items-start relative size-full" data-name="Mobile_Var1_Single_Column">
      <App />
      <Frame />
      <Frame5 />
      <Frame7 />
      ...
      <Frame30 />
      <Frame36 />
      <NarBar className="bg-[#ede8d8] relative shrink-0 w-[393px]" />
    </div>
  );
}