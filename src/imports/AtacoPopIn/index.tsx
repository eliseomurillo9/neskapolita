import svgPaths from "./svg-x94pxyx8y8";
  ...
  return (
    <div className="content-stretch flex flex-col items-start pt-[2px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] font-normal leading-[19.5px] relative shrink-0 text-[#54625d] text-[13px] w-[356px]" style={{ fontVariationSettings: '"opsz" 14' }}>
        Cobblestone streets lined with vivid pastel murals painted by local and international artists.
      </p>
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="content-stretch flex flex-col items-start pt-[2px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] font-normal leading-[19.5px] relative shrink-0 text-[#54625d] text-[13px] w-[356px]" style={{ fontVariationSettings: '"opsz" 14' }}>
        A colorful artisan market selling handwoven textiles, ceramics, and woodwork.
      </p>
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="content-stretch flex flex-col items-start pt-[2px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] font-normal leading-[19.5px] relative shrink-0 text-[#54625d] text-[13px] w-[356px]" style={{ fontVariationSettings: '"opsz" 14' }}>
        Cloud forest reserve with rare wildlife, volcanic lookouts, and challenging trails nearby.
      </p>
    </div>
  );
}
...
export default function AtacoPopIn() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center overflow-clip relative rounded-[16px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] size-full" data-name="Ataco pop-in">
      <Container />
      <Frame />
    </div>
  );
