...
function CardCommunity({ className, property1 = "Default" }: CardCommunityProps) {
  return (
    <div className={className || "bg-white drop-shadow-[0px_4px_6px_rgba(76,110,88,0.05)] relative rounded-[12px] w-[740px]"}>
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[24px] items-center p-[32px] relative size-full">
          ...
          <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col gap-[6px] items-start min-w-px relative" data-name="Card-Community-Text">
            <p className="font-['DM_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#1c2420] text-[18px] whitespace-nowrap" style={{ fontVariationSettings: '"opsz" 14' }}>
              Traveler Community
            </p>
            <p className="font-['DM_Sans:Regular',sans-serif] font-normal leading-[22px] min-w-full relative shrink-0 text-[#54625d] text-[14px] w-[min-content]" style={{ fontVariationSettings: '"opsz" 14' }}>
              Weekly events, dinners, and meetups for modern global nomads.
            </p>
          </div>
        </div>
      </div>
...
function CardLaundry({ className }: { className?: string }) {
  return (
    <div className={className || "bg-white drop-shadow-[0px_4px_6px_rgba(76,110,88,0.05)] relative rounded-[12px] w-[358px]"} data-name="Card-Laundry">
      <div aria-hidden className="absolute border border-[#d5dad7] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="content-stretch flex flex-col gap-[16px] items-start p-[32px] relative size-full">
        ...
        <p className="[word-break:break-word] font-['DM_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#1c2420] text-[18px] whitespace-nowrap" style={{ fontVariationSettings: '"opsz" 14' }}>
          Self-Service Laundry
        </p>
        <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] font-normal leading-[22px] min-w-full relative shrink-0 text-[#54625d] text-[14px] w-[min-content]" style={{ fontVariationSettings: '"opsz" 14' }}>
          24/7 washers and dryers so you can pack light and stay fresh.
        </p>
      </div>
    </div>
  );
...
function CardLounge({ className, property1 = "Default" }: CardLoungeProps) {
  return (
    <div className={className || "bg-white h-[191px] relative rounded-[12px] w-[358px]"}>
      <div className="overflow-clip relative rounded-[inherit] size-full">
        ...
        <p className="[word-break:break-word] absolute font-['DM_Sans:Bold',sans-serif] font-bold leading-[normal] left-[32px] text-[#1c2420] text-[18px] top-[76px] whitespace-nowrap" style={{ fontVariationSettings: '"opsz" 14' }}>
          Shared Lounge Area
        </p>
        <p className="[word-break:break-word] absolute font-['DM_Sans:Regular',sans-serif] font-normal leading-[22px] left-[32px] right-[32px] text-[#54625d] text-[14px] top-[115px]" style={{ fontVariationSettings: '"opsz" 14' }}>
          Cozy community space with deep couches, books, and vinyl records.
        </p>
        {property1 === "hover" && (
          <div className="absolute h-[495px] left-[-151px] top-[-171px] w-[660px]" data-name="IMG_3110 1">
...
function CardKitchen({ className, property1 = "Default" }: CardKitchenProps) {
  const isDefault = property1 === "Default";
  const isHover = property1 === "hover";
  return (
    <div className={className || `bg-white relative rounded-[12px] w-[358px] ${isHover ? "h-[191px]" : "drop-shadow-[0px_4px_6px_rgba(76,110,88,0.05)]"}`}>
      <div aria-hidden={isDefault ? true : undefined} className={isHover ? "overflow-clip relative rounded-[inherit] size-full" : "absolute border border-[#d5dad7] border-solid inset-0 pointer-events-none rounded-[12px]"}>
        {isHover && (
          <>
            ...
            <p className="[word-break:break-word] absolute font-['DM_Sans:Regular',sans-serif] font-normal leading-[22px] left-[32px] right-[32px] text-[#54625d] text-[14px] top-[115px]" style={{ fontVariationSettings: '"opsz" 14' }}>
              Fully equipped space to cook, share recipes, and connect over food.
            </p>
...
function CardGarden({ className, property1 = "Default" }: CardGardenProps) {
  const isDefault = property1 === "Default";
  const isHover = property1 === "hover";
  return (
    <div className={className || `bg-white relative rounded-[12px] w-[358px] ${isHover ? "h-[191px]" : "drop-shadow-[0px_4px_6px_rgba(76,110,88,0.05)]"}`}>
      <div aria-hidden={isDefault ? true : undefined} className={isHover ? "overflow-clip relative rounded-[inherit] size-full" : "absolute border border-[#d5dad7] border-solid inset-0 pointer-events-none rounded-[12px]"}>
        {isHover && (
          <>
            ...
            <p className="[word-break:break-word] absolute font-['DM_Sans:Regular',sans-serif] font-normal leading-[22px] left-[32px] right-[32px] text-[#54625d] text-[14px] top-[115px]" style={{ fontVariationSettings: '"opsz" 14' }}>
              A lush, tranquil green oasis to unwind, read, or enjoy morning coffee.
            </p>
...
function Room3({ className, status = "Default", style = "light" }: Room3Props) {
  const isDefault = status === "Default";
  const isHover = status === "hover";
  return (
    <div className={className || "bg-white h-[416px] relative w-[300px]"}>
              ...
              <div className="relative shrink-0 w-full">
                <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[16px] items-start relative size-full">
                          ...
                          <div className="relative shrink-0 w-full" data-name="Heading 3:margin">
                            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[1.718px] pt-[3.437px] relative size-full">
                              <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
                                <p className="[word-break:break-word] font-['Fraunces:Bold',sans-serif] font-bold leading-[18.902px] relative shrink-0 text-[#0a1209] text-[12.601px] whitespace-nowrap" style={{ fontVariationSettings: '"SOFT" 0, "WONK" 1' }}>
                                  Casa nieves
                                </p>
                              </div>
                            </div>
                          ...
                          <div className="relative shrink-0 w-full" data-name="Paragraph:margin">
                            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[1.146px] relative size-full">
                              <div className="content-stretch flex flex-col items-end opacity-40 relative shrink-0 w-full" data-name="Paragraph">
                                <p className="[word-break:break-word] font-['DM_Sans:9pt_Regular',sans-serif] font-normal leading-[10.31px] relative shrink-0 text-[#0a1209] text-[6.873px] text-right whitespace-nowrap" style={{ fontVariationSettings: '"opsz" 9' }}>
                                  /night
                                </p>
                              </div>
                            </div>
                  ...
                  <div className={`content-stretch flex relative shrink-0 ${isHover ? "flex-col gap-[12px] items-start w-full" : "items-center justify-between w-[275px]"}`}>
                    {isDefault && (
                      <>
                        <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] font-normal leading-[14.319px] relative shrink-0 text-[#0a1209] text-[9.308px] w-[113.84px]" style={{ fontVariationSettings: '"opsz" 14' }}>
                          Chambre Twin avec salle de bain privée
                        </p>
                    ...
                    {isHover && (
                      <>
                            ...
                            <div className="relative shrink-0 w-[32.28px]" data-name="Container">
                              <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
                                ...
                                <div className="relative shrink-0 w-full" data-name="Paragraph:margin">
                                  <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[1.146px] relative size-full">
                                    <div className="content-stretch flex flex-col items-end opacity-40 relative shrink-0 w-full" data-name="Paragraph">
                                      <p className="[word-break:break-word] font-['DM_Sans:9pt_Regular',sans-serif] font-normal leading-[10.31px] relative shrink-0 text-[#0c1a10] text-[6.873px] text-right whitespace-nowrap" style={{ fontVariationSettings: '"opsz" 9' }}>
                                        /night
                                      </p>
                                    </div>
                                  </div>
                        ...
                        <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
                          <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] font-normal leading-[14.319px] relative shrink-0 text-[#0c1a10] text-[9.308px] text-center w-full" style={{ fontVariationSettings: '"opsz" 14' }}>{`Discover the amenities and more : `}</p>
                        </div>
                      </>
                    )}
                  </div>
...
function Room2({ className, status = "Default", style = "light" }: Room2Props) {
  const isDefault = status === "Default";
  const isHover = status === "hover";
  return (
    <div className={className || "bg-white h-[416px] relative w-[300px]"}>
              ...
              <div className="relative shrink-0 w-full">
                <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[16px] items-start relative size-full">
                  ...
                  <div className={`content-stretch flex relative shrink-0 ${isHover ? "flex-col gap-[12px] items-start w-full" : "items-center justify-between w-[275px]"}`}>
                    {isDefault && (
                      <>
                        <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] font-normal leading-[14.319px] relative shrink-0 text-[#0c1a10] text-[9.308px] w-[113.84px]" style={{ fontVariationSettings: '"opsz" 14' }}>
                          Chambre Twin avec salle de bain privée
                        </p>
                        <div className="bg-[#3d9e72] drop-shadow-[0px_4px_6px_rgba(61,158,114,0.3)] h-[36px] relative shrink-0 w-[116px]" data-name="V2 / Primary Button">
                          <div className="flex flex-row items-center size-full">
                    ...
                    {isHover && (
                      <>
                        ...
                        <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
                          <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] font-normal leading-[14.319px] relative shrink-0 text-[9.308px] text-center text-white w-full" style={{ fontVariationSettings: '"opsz" 14' }}>{`Discover the amenities and more : `}</p>
                          <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full" data-name="Services Row">
                            <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-center min-w-px relative" data-name="Service Item">
                              <div className="bg-[rgba(61,158,114,0.2)] content-stretch flex flex-col items-center justify-center relative rounded-[6px] shrink-0 size-[24px]" data-name="Icon Frame">
...
function Room1({ className, status = "Default", style = "light" }: Room1Props) {
  const isHover = status === "hover";
  return (
    <div className={className || "bg-white h-[416px] relative w-[300px]"}>
      <div className="overflow-clip rounded-[inherit] size-full">
            ...
            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[10px] pt-[10.716px] px-[12px] relative size-full">
              <div className="relative shrink-0 w-full">
                <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[16px] items-start relative size-full">
                  <div className="content-stretch flex items-start justify-between relative shrink-0 w-full" data-name="Container">
                    ...
                    <div className="relative shrink-0 w-[32.28px]" data-name="Container">
                      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
                        <div className="relative shrink-0 w-full" data-name="Paragraph">
                          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-end relative size-full">
                            <p className="[word-break:break-word] font-['Fraunces:Bold',sans-serif] font-bold leading-[17.183px] relative shrink-0 text-[#0a1209] text-[17.183px] text-right whitespace-nowrap" style={{ fontVariationSettings: '"SOFT" 0, "WONK" 1' }}>
                              $45
                            </p>
                          </div>
                        </div>
                        <div className="relative shrink-0 w-full" data-name="Paragraph:margin">
                          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[1.146px] relative size-full">
                            <div className="content-stretch flex flex-col items-end opacity-40 relative shrink-0 w-full" data-name="Paragraph">
                              <p className={`[word-break:break-word] font-["DM_Sans:9pt_Regular",sans-serif] font-normal leading-[10.31px] relative shrink-0 text-[6.873px] text-right whitespace-nowrap ${isHover ? "text-[#ede8d8]" : "text-[#0a1209]"}`} style={{ fontVariationSettings: '"opsz" 9' }}>
                                /night
                              </p>
                            </div>
                          </div>
                  ...
                  <div className={`content-stretch flex relative shrink-0 ${isHover ? "flex-col gap-[12px] items-start w-full" : "items-center justify-between w-[275px]"}`}>
                    <p className={`[word-break:break-word] font-["DM_Sans:Regular",sans-serif] font-normal leading-[14.319px] relative shrink-0 text-[#0a1209] text-[9.308px] ${isHover ? "w-full" : "w-[113.84px]"}`} style={{ fontVariationSettings: '"opsz" 14' }}>
...
function Room({ className, status = "Default", style = "light" }: RoomProps) {
  const isDefault = status === "Default";
  const isHover = status === "hover";
  return (
    <div className={className || "bg-white h-[416px] relative w-[300px]"}>
        ...
        <div className="content-stretch flex flex-col items-start p-[0.716px] relative size-full">
          <div className={`bg-white relative shrink-0 w-full ${isDefault ? "h-[306.436px]" : "h-[216px]"}`}>
            <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
              ...
              {isHover && (
                <div className="absolute h-[418px] left-[-13.72px] top-[-69.72px] w-[313px]" data-name="image">
              ...
              <div className="relative shrink-0 w-full">
                <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[16px] items-start relative size-full">
                  <div className="content-stretch flex items-start justify-between relative shrink-0 w-full" data-name="Container">
                    ...
                    <div className="relative shrink-0 w-[32.28px]" data-name="Container">
                      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
                        <div className="relative shrink-0 w-full" data-name="Paragraph">
                          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-end relative size-full">
                            <p className={`[word-break:break-word] font-["Fraunces:Bold",sans-serif] font-bold leading-[17.183px] relative shrink-0 text-[17.183px] text-right whitespace-nowrap ${isDefault ? "text-[#18271c]" : "text-[#0c1a10]"}`} style={{ fontVariationSettings: '"SOFT" 0, "WONK" 1' }}>
                              $45
                            </p>
                          </div>
                        </div>
                        <div className="relative shrink-0 w-full" data-name="Paragraph:margin">
                          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[1.146px] relative size-full">
                            <div className="content-stretch flex flex-col items-end opacity-40 relative shrink-0 w-full" data-name="Paragraph">
                              <p className={`[word-break:break-word] font-["DM_Sans:9pt_Regular",sans-serif] font-normal leading-[10.31px] relative shrink-0 text-[6.873px] text-right whitespace-nowrap ${isDefault ? "text-[#0c1a10]" : "text-[#ede8d8]"}`} style={{ fontVariationSettings: '"opsz" 9' }}>
                                /night
                              </p>
                            </div>
                          </div>
                  ...
                  <div className={`content-stretch flex relative shrink-0 ${isDefault ? "items-center justify-between w-[275px]" : "flex-col gap-[12px] items-start w-full"}`}>
                    <p className={`[word-break:break-word] font-["DM_Sans:Regular",sans-serif] font-normal leading-[14.319px] relative shrink-0 text-[9.308px] ${isDefault ? "text-[#0a1209] w-[113.84px]" : "text-[#0c1a10] w-full"}`} style={{ fontVariationSettings: '"opsz" 14' }}>
                    ...
                    {isDefault && (
                      <div className="bg-[#3d9e72] h-[36px] relative shrink-0 w-[116px]" data-name="V2 / Primary Button">
                        <div className="flex flex-row items-center size-full">
                          <div className="[word-break:break-word] content-stretch flex gap-[8px] items-center px-[28px] py-[14px] relative size-full text-white whitespace-nowrap">
                            <p className="font-['DM_Sans:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[13px]" style={{ fontVariationSettings: '"opsz" 14' }}>{`Explore `}</p>
                            <p className="font-['Nunito:Bold','Noto_Sans_Symbols:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[16px]">→</p>
...
function Button() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0" data-name="Button">
      <p className="[word-break:break-word] font-['DM_Sans:Bold',sans-serif] font-bold leading-[17.28px] relative shrink-0 text-[#1c2420] text-[11.52px] text-center tracking-[1.38px] uppercase whitespace-nowrap" style={{ fontVariationSettings: '"opsz" 14' }}>
        Rooms
      </p>
    </div>
  );
...
function Container() {
  return (
    <div className="content-stretch flex gap-[40px] items-center relative shrink-0 w-[614.5px]" data-name="Container">
      <Button />
      <Button1 />
      <Button2 />
    </div>
...
function Text() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['DM_Sans:Bold',sans-serif] font-bold leading-[16.5px] relative shrink-0 text-[#3d9e72] text-[11px] text-center tracking-[1px] whitespace-nowrap" style={{ fontVariationSettings: '"opsz" 14' }}>
        EN
      </p>
    </div>
  );
...
function Text2() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['DM_Sans:Bold',sans-serif] font-bold leading-[16.5px] relative shrink-0 text-[#1c2420] text-[11px] text-center tracking-[1px] whitespace-nowrap" style={{ fontVariationSettings: '"opsz" 14' }}>
        ES
      </p>
    </div>
  );
...
function ButtonSwitchLanguage() {
  return (
    <div className="bg-[rgba(28,36,32,0.04)] border border-[#3d9e72] border-solid content-stretch flex gap-[4px] items-center px-[12px] py-[8px] relative rounded-[16777200px] shrink-0" data-name="Button - Switch language">
      <Text />
      <Text1 />
      <Text2 />
    </div>
...
function ButtonToggleLightDarkMode() {
  return (
    <div className="bg-[rgba(28,36,32,0.04)] border border-[#3d9e72] border-solid content-stretch flex items-center justify-center relative rounded-[16777200px] shrink-0 size-[43px]" data-name="Button - Toggle light/dark mode">
      <Container2 />
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Paragraph">
      <p className="[word-break:break-word] font-['DM_Sans:Bold',sans-serif] font-bold leading-[16.8px] relative shrink-0 text-[11.2px] text-white tracking-[1.12px] uppercase whitespace-nowrap" style={{ fontVariationSettings: '"opsz" 14' }}>
        Book Now
      </p>
    </div>
  );
...
function Container3() {
  return (
    <div className="bg-[#3d9e72] content-stretch flex gap-[8px] items-center px-[20px] py-[10px] relative rounded-[4px] shrink-0" data-name="Container">
      <Container4 />
      <Paragraph />
    </div>
  );
...
function Container1() {
  return (
    <div className="content-stretch flex gap-[12px] items-center justify-end relative shrink-0 w-[614.5px]" data-name="Container">
...
function Paragraph1() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[604.5px] top-[19px] w-[132px]" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Fraunces:Black_Italic',sans-serif] font-black italic leading-[33.6px] relative shrink-0 text-[#4c6e58] text-[22.4px] tracking-[-0.22px] whitespace-nowrap" style={{ fontVariationSettings: '"SOFT" 0, "WONK" 1' }}>
        Neskapolita
      </p>
    </div>
  );
...
function NavBar1() {
  return (
    <div className="content-stretch flex h-[72px] items-center justify-between px-[56px] relative shrink-0 w-full" data-name="NavBar">
      <Container />
      <Container1 />
      <Paragraph1 />
    </div>
...
function NavBar() {
  return (
    <div className="bg-[#f2f4f3] content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="nav-bar">
...
function ImageLushTropicalFlowersAndForestOfElSalvador() {
  return (
    <div className="absolute h-[689px] left-0 opacity-80 top-0 w-[1440px]" data-name="Image (Lush tropical flowers and forest of El Salvador)">
...
function Container5() {
  return <div className="absolute h-[600px] left-0 top-0 w-[1440px]" style={{ backgroundImage: "linear-gradient(181.764732956067deg, rgba(12, 26, 16, 0.21) 18.553%, rgba(12, 26, 16, 0.49) 71.936%, rgba(12, 26, 16, 0.665) 102.8%)" }} data-name="Container" />;
}

function NameAndPhrase() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col font-black gap-[20px] items-start relative shrink-0 whitespace-nowrap" data-name="name and phrase">
      <p className="font-['Fraunces:Black_Italic',sans-serif] italic leading-[67.015px] relative shrink-0 text-[#f2b138] text-[67.015px]" style={{ fontVariationSettings: '"SOFT" 0, "WONK" 1' }}>
        Neskapolita
      </p>
      <p className="font-['Fraunces:Black',sans-serif] leading-[normal] relative shrink-0 text-[30px] text-white" style={{ fontVariationSettings: '"SOFT" 0, "WONK" 1' }}>
      ...
      <div className="bg-[#f2b138] relative shrink-0" data-name="V1 / Primary Button">
        <div className="flex flex-row items-center size-full">
          <div className="[word-break:break-word] content-stretch flex font-bold gap-[10px] items-center leading-[normal] px-[32px] py-[16px] relative size-full text-[#0c1a10] whitespace-nowrap">
            <p className="font-['Sora:Bold',sans-serif] relative shrink-0 text-[11px] tracking-[3px] uppercase">Explore Rooms</p>
      ...
      <div className="bg-[#3d9e72] drop-shadow-[0px_4px_6px_rgba(61,158,114,0.3)] relative shrink-0" data-name="V2 / Primary Button">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[8px] items-center px-[28px] py-[14px] relative size-full">
            <p className="[word-break:break-word] font-['DM_Sans:Medium',sans-serif] font-medium leading-[17.28px] relative shrink-0 text-[#ede8d8] text-[11.52px] tracking-[1.3824px] uppercase whitespace-nowrap" style={{ fontVariationSettings: '"opsz" 14' }}>
              Our Story
            </p>
          </div>
        </div>
...
function Paragraph2() {
  return (
    <div className="relative shrink-0 w-full" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Fraunces:Bold','Noto_Sans:Bold','Noto_Sans_Math:Regular','Noto_Sans_Symbols:Bold','Noto_Sans_Symbols2:Regular',sans-serif] font-bold leading-[33.6px] relative shrink-0 text-[#f2b138] text-[22.4px] whitespace-nowrap" style={{ fontVariationSettings: '"SOFT" 0, "WONK" 1' }}>
          ★ 4.9
        </p>
      </div>
    </div>
...
function Paragraph3() {
  return (
    <div className="content-stretch flex flex-col items-start opacity-45 relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['DM_Sans:9pt_Regular',sans-serif] font-normal leading-[14.4px] relative shrink-0 text-[9.6px] text-white tracking-[1.344px] uppercase whitespace-nowrap" style={{ fontVariationSettings: '"opsz" 9' }}>
        Booking raiting
      </p>
    </div>
  );
...
function Container9() {
  return (
    <div className="relative shrink-0 w-[81.328px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Paragraph2 />
        <ParagraphMargin />
      </div>
...
function KeyNumbers() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="key numbers">
      <Container9 />
    </div>
  );
}
...
function Container8() {
  return (
    <div className="content-stretch flex h-[52.2px] items-start relative shrink-0 w-full" data-name="Container">
      <Content />
    </div>
  );
}
...
function Container6() {
  return (
    <div className="absolute content-stretch flex flex-col h-[600px] items-start justify-center left-0 pb-[112px] px-[90px] top-0 w-[1440px]" data-name="Container">
      <Container7 />
    </div>
  );
}
...
function Section() {
  return (
    <div className="bg-[#0c1a10] h-[600px] min-h-[600px] overflow-clip relative shrink-0 w-full" data-name="Section">
...
function Background() {
  return (
    <div className="absolute h-[350px] left-0 top-0 w-[1440px]" data-name="background">
...
function Heading() {
  return (
    <div className="content-stretch flex flex-col h-[107px] items-start pb-[24px] relative shrink-0 w-[843px]" data-name="Heading 2">
      <p className="[word-break:break-word] font-['Fraunces:Black',sans-serif] font-black leading-[0] relative shrink-0 text-[#ede8d8] text-[0px] text-center w-full whitespace-pre-wrap" style={{ fontVariationSettings: '"SOFT" 0, "WONK" 1' }}>
        ...
        <span className="font-['Fraunces:Black_Italic',sans-serif] italic leading-[36.291px] text-[#3d9e72] text-[32.992px]" style={{ fontVariationSettings: '"SOFT" 0, "WONK" 1' }}>{`"Pretty Girl"`}</span>
      </p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex items-center justify-center py-[20px] relative shrink-0">
      <p className="[word-break:break-word] font-['DM_Sans:9pt_Regular',sans-serif] font-normal h-[29px] leading-[28.704px] relative shrink-0 text-[#131f16] text-[14.72px] w-[498px]" style={{ fontVariationSettings: '"opsz" 9' }}>
...
function ParagraphMargin1() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Paragraph:margin">
      <Frame1 />
    </div>
  );
}
...
function Text3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-center justify-center min-w-px relative" data-name="text">
      <Heading />
      <ParagraphMargin1 />
      <div className="relative rounded-[4px] shrink-0 w-[326px]" data-name="V3 / Secondary Button">
        ...
        <div className="flex flex-row items-center justify-center size-full">
          <div className="[word-break:break-word] content-stretch flex gap-[12px] items-center justify-center leading-[normal] not-italic px-[24px] py-[14px] relative size-full whitespace-nowrap">
            <p className="font-['Space_Mono:Bold',sans-serif] relative shrink-0 text-[#4c6e58] text-[12px] tracking-[1.5px] uppercase">Read the Full Story</p>
...
function Logo() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[80px] top-[68px] w-[1280px]" data-name="logo">
...
function Section1() {
  return (
    <div className="h-[350px] overflow-clip relative shrink-0 w-[1440px]" data-name="Section">
      <Background />
      <Logo />
    </div>
  );
...
function HeaderGroup() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[8px] items-center relative shrink-0 w-full" data-name="Header Group">
      <p className="font-['Fraunces:Black',sans-serif] font-black leading-[0] relative shrink-0 text-[#1c2420] text-[28px] whitespace-nowrap" style={{ fontVariationSettings: '"SOFT" 0, "WONK" 1' }}>
        ...
        <span className="leading-[normal] text-[#3d9e72]">Casa</span>
      </p>
      <p className="font-['DM_Sans:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#54625d] text-[15px] text-center w-[720px]" style={{ fontVariationSettings: '"opsz" 14' }}>
        From shared dorms to private rooms with a view — every space at Neskapolita has its own story to tell.
      </p>
    </div>
  );
}
...
function CardsContainer() {
  return (
    <div className="content-stretch flex gap-[24px] items-start justify-center relative shrink-0 w-full" data-name="Cards Container">
...
function RoomFinderRow() {
  return (
    <div className="bg-[#f2f4f3] content-stretch flex flex-col gap-[48px] items-start px-[56px] py-[80px] relative shrink-0 w-[1440px]" data-name="Room Finder Row">
      <HeaderGroup />
      <CardsContainer />
    </div>
  );
...
function SavingsBannerSection() {
  return (
    <div className="bg-[#ede8d8] relative shrink-0 w-full" data-name="Savings Banner Section">
...
function V1LeftCol() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[420px]" data-name="V1-Left-Col">
      <p className="[word-break:break-word] font-['Fraunces:Black',sans-serif] font-black leading-[56px] relative shrink-0 text-[#1c2420] text-[48px] w-full whitespace-pre-wrap" style={{ fontVariationSettings: '"SOFT" 0, "WONK" 1' }}>
        {`Everything `}
        <br aria-hidden />
        you need
        <br aria-hidden />
...
function V1GridRow() {
  return (
    <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full" data-name="V1-Grid-Row-1">
...
function V1GridRow1() {
  return (
    <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full" data-name="V1-Grid-Row-2">
...
function V1RightCol() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-start min-w-px relative" data-name="V1-Right-Col">
      <V1GridRow />
      <V1GridRow1 />
...
function V1Columns() {
  return (
    <div className="content-stretch flex gap-[80px] items-start relative shrink-0 w-full" data-name="V1-Columns">
      <V1LeftCol />
      <V1RightCol />
    </div>
  );
...
function AmenitiesSection() {
  return (
    <div className="bg-[#f2f4f3] content-stretch flex flex-col items-start overflow-clip p-[100px] relative shrink-0 w-[1440px]" data-name="Amenities Section">
      <V1Columns />
    </div>
  );
}
...
function RutaDeLasFloresLight() {
  return (
    <div className="h-[717.202px] relative shrink-0 w-full" data-name="ruta-de-las-flores-light">
...
function Paragraph5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] font-normal leading-[23.4px] relative shrink-0 text-[#54625d] text-[13px] w-[300px]" style={{ fontVariationSettings: '"opsz" 14' }}>
...
function Container16() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-full items-start max-w-[300px] relative shrink-0" data-name="Container">
      <Paragraph4 />
      <Paragraph5 />
      <Paragraph6 />
    </div>
...
function Container18() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] h-full items-start min-w-[100px] relative shrink-0" data-name="Container">
      <Paragraph7 />
      <Paragraph8 />
    </div>
  );
...
function Container17() {
  return (
    <div className="content-stretch flex gap-[64px] h-full items-start relative shrink-0" data-name="Container">
      <Container18 />
      <Container19 />
      <Container20 />
    </div>
...
function Container15() {
  return (
    <div className="content-stretch flex h-[240.891px] items-start justify-between max-w-[1440px] p-[56px] relative shrink-0 w-full" data-name="Container">
      <Container16 />
      <Container17 />
    </div>
  );
...
export default function DesktopV() {
  return (
    <div className="bg-[#f2f4f3] content-stretch flex flex-col items-start relative size-full" data-name="desktop-V1">
      <NavBar />
      <Section />
      <Section1 />
      <RoomFinderRow />
