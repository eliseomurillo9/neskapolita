...
function ButtonSwitchLanguage() {
  ...
  return (
    <div className="bg-[rgba(28,36,32,0.04)] border border-[#3d9e72] border-solid content-stretch flex gap-[4px] items-center px-[12px] py-[8px] relative rounded-[16777200px] shrink-0" data-name="Button - Switch language" onClick={toggleLanguage} style={{ cursor: "pointer" }}>
