...
export default function ButtonPrimary({
  ...
  return <div className={className || "bg-[#3d9e72] drop-shadow-[0px_4px_6px_rgba(76,110,88,0.05)] relative rounded-[4px] cursor-pointer"} data-name="Button-primary" onClick={onClick}>
