...
function NarBar({ className, format = "mobile", style = "dark" }: NarBarProps) {
  return (
    <div className={className || "bg-[#0c1a10] relative w-[393px]"}>
        ...
        <div className="content-stretch flex flex-col gap-[20px] items-center justify-center max-w-[1440px] px-[24px] py-[56px] relative shrink-0 w-full" data-name="Container">
          <div className="content-stretch flex flex-col gap-[16px] items-center relative shrink-0 w-full" data-name="Container">
            <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-full" data-name="Paragraph">
              <p className="[word-break:break-word] font-['Fraunces:Black_Italic',sans-serif] font-black italic leading-[33.6px] relative shrink-0 text-[#f2b138] text-[22.4px] whitespace-nowrap" style={{ fontVariationSettings: '"SOFT" 0, "WONK" 1' }}>
                Neskapolita
              </p>
            </div>
            <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-full" data-name="Paragraph">
              <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] font-normal leading-[23.4px] relative shrink-0 text-[13px] text-center text-white w-[300px]" style={{ fontVariationSettings: '"opsz" 14' }}>
          ...
          <div className="content-stretch flex flex-col gap-[6px] items-center justify-center min-w-[100px] relative shrink-0" data-name="Container">
            ...
            <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-full" data-name="Paragraph">
              <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] font-normal leading-[19.5px] relative shrink-0 text-[13px] text-white whitespace-nowrap" style={{ fontVariationSettings: '"opsz" 14' }}>
                Book Now
              </p>
            </div>
          </div>
          ...
          <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-full" data-name="Paragraph">
            <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] font-normal leading-[16.5px] relative shrink-0 text-[#ede8d8] text-[11px] whitespace-nowrap" style={{ fontVariationSettings: '"opsz" 14' }}>
...
export default function NarBar1() {
  return <NarBar className="bg-[#0c1a10] relative size-full" />;
}