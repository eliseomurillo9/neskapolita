...
function Frame1() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[8px] items-center relative shrink-0 w-full" data-name="Frame">
...
export default function BookingPayments() {
  return (
    <div className="bg-[#ede8d8] content-stretch flex flex-col gap-[20px] items-center justify-center p-[24px] relative size-full" data-name="Booking & Payments">
      <Frame />
      <Frame1 />
      <Frame2 />
      <RightColumn />
