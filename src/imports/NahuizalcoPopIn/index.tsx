...
function Paragraph3() {
  return <div className="content-stretch flex flex-col items-start pt-[2px] relative shrink-0 w-full" data-name="Paragraph">
      ...
      fontVariationSettings: '"opsz" 14'
    }}>{`El Salvador's only candlelit night market — warm pupusas, live marimba, and local craft stalls.`}</p>
    </div>;
}
function Container5() {
...
function Paragraph5() {
  return <div className="content-stretch flex flex-col items-start pt-[2px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] font-normal leading-[19.5px] relative shrink-0 text-[#54625d] text-[13px] w-[356px]" style={{
      fontVariationSettings: '"opsz" 14'
    }}>{t("index.watch_master_artisans_weave")}</p>
    </div>;
}
function Container7() {
  return <div className="content-stretch flex flex-[356_0_0] flex-col items-start min-w-px relative" data-name="Container">
...
function Paragraph7() {
  return <div className="content-stretch flex flex-col items-start pt-[2px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] font-normal leading-[19.5px] relative shrink-0 text-[#54625d] text-[13px] w-[356px]" style={{
      fontVariationSettings: '"opsz" 14'
    }}>{`Colonial-era church with a distinctive white façade, central to the town's indigenous festivals.`}</p>
    </div>;
}
function Container9() {
  return <div className="content-stretch flex flex-[356_0_0] flex-col items-start min-w-px relative" data-name="Container">
...
export default function NahuizalcoPopIn() {
  return <div className="bg-white content-stretch flex flex-col items-center justify-center overflow-clip relative rounded-[16px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] size-full" data-name="Nahuizalco pop-in">
      <Container />
      <Frame />
    </div>;
}
