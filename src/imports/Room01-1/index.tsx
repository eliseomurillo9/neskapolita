...
function ActionRow() {
  return <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Action Row">
      <Frame />
...
export default function Room() {
  return <div className="bg-white relative size-full" data-name="room01">
