...
function Link() {
  return <div className="relative shrink-0" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
...
function Container1() {
  return <div className="relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center justify-center relative size-full">
        <div className="relative shrink-0 size-[30px]" data-name="Icon">
          <div className="absolute inset-[13.71%_12.5%]" data-name="vector">
            <svg className="absolute block inset-0 size-full" fill="none" height="21.7742" preserveAspectRatio="none" viewBox="0 0 22.5 21.7742" width="22.5">
              <path d={svgPaths.p3098df00} fill="var(--fill-0, white)" id="vector" />
            </svg>
          </div>
        </div>
...
function Button() {
  return <div className="bg-[#3d9e72] relative shrink-0 w-[167px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center px-[24px] py-[8.8px] relative size-full">
        <Container1 />
      </div>
    </div>;
}
...
function Navigation() {
  return <div className="bg-[rgba(12,26,16,0.92)] h-[72px] relative shrink-0 w-full" data-name="Navigation">
      <div aria-hidden className="absolute border-[rgba(237,232,216,0.07)] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-between pb-px px-[56px] relative size-full">
          <Text />
          <Container />
        </div>
      </div>
...
function Container2() {
  return <div className="absolute h-[600px] left-0 top-0 w-[1440px]" style={{
    backgroundImage: "linear-gradient(181.765deg, rgba(12, 26, 16, 0.21) 18.553%, rgba(12, 26, 16, 0.49) 71.936%, rgba(12, 26, 16, 0.667) 102.8%)"
  }} data-name="Container" />;
}
...
function Paragraph() {
  return <div className="relative shrink-0 w-full" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Fraunces:Bold','Noto_Sans_Symbols2:Regular',sans-serif] font-bold leading-[33.6px] relative shrink-0 text-[#f2b138] text-[22.4px] whitespace-nowrap" style={{
        fontVariationSettings: '"SOFT" 0, "WONK" 1'
      }}>
          ★ 4.9
        </p>
...
function Container7() {
  return <div className="relative shrink-0 w-[97.211px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Paragraph2 />
        <ParagraphMargin1 />
      </div>
...
function Container8() {
  return <div className="relative shrink-0 w-[101.203px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Paragraph4 />
        <ParagraphMargin2 />
      </div>
...
function KeyNumbers() {
  return <div className="content-stretch flex gap-[48px] items-center justify-center relative shrink-0" data-name="key numbers">
      <Container6 />
      <Container7 />
      <Container8 />
    </div>;
...
function Section() {
  return <div className="bg-[#0c1a10] h-[600px] min-h-[600px] relative shrink-0 w-full" data-name="Section">
...
function Heading() {
  return <div className="content-stretch flex flex-col h-[107px] items-start pb-[24px] relative shrink-0 w-[843px]" data-name="Heading 2">
      ...
      fontVariationSettings: '"SOFT" 0, "WONK" 1'
        ...
        <span className="font-['Fraunces:Black_Italic',sans-serif] italic leading-[36.291px] text-[#f2b138] text-[32.992px]" style={{
        fontVariationSettings: '"SOFT" 0, "WONK" 1'
      }}>{`"Pretty Girl"`}</span>
      </p>
    </div>;
...
function Logo() {
  return <div className="relative shrink-0 w-full" data-name="logo">
...
function Container9() {
  return <div className="absolute bg-[#0a1209] content-stretch flex flex-col h-[400px] items-start justify-center left-0 px-[80px] py-[88px] top-0 w-[1440px]" data-name="Container">
      <Logo />
    </div>;
}
function Section1() {
  return <div className="bg-[#0c1a10] h-[350px] min-h-[300px] relative shrink-0 w-[1440px]" data-name="Section">
...
function Header() {
  return <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Header">
      <Frame />
    </div>;
}
...
function Frame1() {
  return <div className="bg-white h-[306.436px] relative shrink-0 w-full">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <div className="absolute h-[418px] left-[-11.99px] top-[-70.12px] w-[313px]" data-name="image">
        ...
        <div className="absolute h-[22px] left-[228.01px] top-[-0.12px] w-[71px]" data-name="tags">
          <Container10 />
        </div>
...
function Heading3Margin() {
  return <div className="relative shrink-0 w-full" data-name="Heading 3:margin">
...
function Container13() {
  return <div className="relative shrink-0 w-[109.415px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Heading3Margin />
      </div>
    </div>;
...
function Paragraph7() {
  return <div className="relative shrink-0 w-full" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-end relative size-full">
        <p className="[word-break:break-word] font-['Fraunces:Bold',sans-serif] font-bold leading-[17.183px] relative shrink-0 text-[#f2b138] text-[17.183px] text-right whitespace-nowrap" style={{
        fontVariationSettings: '"SOFT" 0, "WONK" 1'
      }}>
          $45
        </p>
...
function Container14() {
  return <div className="relative shrink-0 w-[32.28px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Paragraph7 />
        <ParagraphMargin4 />
      </div>
...
function Container12() {
  return <div className="content-stretch flex items-start justify-between relative shrink-0 w-full" data-name="Container">
      <Container13 />
      <Container14 />
    </div>;
}
...
function Container11() {
  return <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Container">
...
function Frame4() {
  return <div className="bg-white h-[302.14px] relative shrink-0 w-full">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
...
function RowContainer() {
  return <div className="content-stretch flex gap-[43px] items-start relative shrink-0 w-full" data-name="Row Container">
      <div className="bg-[#0a1209] h-[416px] relative shrink-0 w-[300px]" data-name="room01">
        <div className="content-stretch flex flex-col items-start overflow-clip p-[0.716px] relative rounded-[inherit] size-full">
          <Frame1 />
          <Container11 />
        </div>
        <div aria-hidden className="absolute border-[0.716px] border-[rgba(61,158,114,0.12)] border-solid inset-0 pointer-events-none" />
      </div>
      <div className="bg-[#0a1209] h-[416px] relative shrink-0 w-[300px]" data-name="room02">
        <div className="content-stretch flex flex-col items-start overflow-clip p-[0.716px] relative rounded-[inherit] size-full">
          <Frame2 />
          <Container15 />
        </div>
      ...
      <div className="bg-[#0a1209] h-[416px] relative shrink-0 w-[300px]" data-name="room03">
        <div className="content-stretch flex flex-col items-start overflow-clip p-[0.716px] relative rounded-[inherit] size-full">
          <Frame3 />
          <Container19 />
        </div>
      ...
      <div className="bg-[#0a1209] h-[416px] relative shrink-0 w-[300px]" data-name="room04">
        <div className="content-stretch flex flex-col items-start overflow-clip p-[0.716px] relative rounded-[inherit] size-full">
          <Frame4 />
          <Container23 />
        </div>
...
function RoomsRow4Col() {
  return <div className="bg-[#18271c] relative shrink-0 w-full" data-name="rooms-row-4col">
      <div aria-hidden className="absolute border-[rgba(237,232,216,0.07)] border-solid border-t-[0.716px] inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[45.822px] items-start pb-[85.917px] pt-[66.585px] px-[57.278px] relative size-full">
        <Header />
        <RowContainer />
      </div>
    </div>;
...
function BadgeCircle() {
  return <div className="bg-[#f2b138] drop-shadow-[0px_4px_6px_rgba(242,177,56,0.2)] relative rounded-[32px] shrink-0 size-[64px]" data-name="Badge_Circle">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center relative size-full">
        <p className="[word-break:break-word] font-['Outfit:ExtraBold',sans-serif] font-extrabold leading-[normal] relative shrink-0 text-[#131f16] text-[18px] whitespace-nowrap">10%</p>
      </div>
    </div>;
}
function Heading5() {
  return <div className="relative shrink-0 w-full" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Fraunces:Black',sans-serif] font-black leading-[0] relative shrink-0 text-[#ede8d8] text-[0px] whitespace-nowrap" style={{
        fontVariationSettings: '"SOFT" 0, "WONK" 1'
      }}>
          <span className="leading-[30.718px] text-[27.925px]">{`Save `}</span>
          <span className="font-['Fraunces:Black_Italic',sans-serif] italic leading-[30.718px] text-[#f2b138] text-[27.925px]" style={{
          fontVariationSettings: '"SOFT" 0, "WONK" 1'
        }}>
            10%
          </span>
...
function ParagraphMargin8() {
  return <div className="relative shrink-0" data-name="Paragraph:margin">
...
function Icon() {
  return <div className="relative shrink-0 size-[12px]" data-name="Icon">
...
function Button1() {
  return <div className="bg-[#3d9e72] relative shrink-0" data-name="Button">
...
function Container28() {
  return <div className="content-stretch flex flex-col gap-[20px] items-start pr-[64px] relative shrink-0 w-[502px]" data-name="Container">
      <BadgeCircle />
      <Container29 />
      <Button1 />
    </div>;
...
function Paragraph16() {
  return <div className="relative shrink-0 w-full" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['DM_Sans:9pt_Regular',sans-serif] font-normal leading-[25.344px] relative shrink-0 text-[#ede8d8] text-[14.08px] w-[470px]" style={{
        fontVariationSettings: '"opsz" 9'
      }}>{`We accept various ways to pay so you can focus on the adventure `}</p>
      </div>
    </div>;
}
function Icon1() {
  return <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="20" preserveAspectRatio="none" viewBox="0 0 20 20" width="20">
        <g id="Icon">
          <path d={svgPaths.p30a86180} fill="var(--fill-0, #009CDE)" id="Vector" opacity="0.9" />
          <path d={svgPaths.p2941ff00} fill="var(--fill-0, #012169)" id="Vector_2" opacity="0.8" />
        </g>
      </svg>
    </div>;
}
...
function Container33() {
  return <div className="relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[5.6px] items-center relative size-full">
        <Icon1 />
        <Text2 />
      </div>
    </div>;
...
function Paragraph17() {
  return <div className="relative shrink-0" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
...
function Container32() {
  return <div className="bg-[rgba(237,232,216,0.04)] flex-[151.328_0_0] min-w-px relative" data-name="Container">
      <div aria-hidden className="absolute border border-[rgba(237,232,216,0.08)] border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col items-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[9.6px] items-center px-[25px] py-[21px] relative size-full">
          <Container33 />
          <Paragraph17 />
        </div>
      </div>
...
function Text3() {
  return <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['DM_Sans:Bold',sans-serif] font-bold leading-[18px] relative shrink-0 text-[#3d9e72] text-[12px] whitespace-nowrap" style={{
        fontVariationSettings: '"opsz" 14'
      }}>
          $
        </p>
...
function Container35() {
  return <div className="h-[22px] relative rounded-[3px] shrink-0 w-[32px]" data-name="Container">
      <div aria-hidden className="absolute border-[1.5px] border-[rgba(61,158,114,0.6)] border-solid inset-0 pointer-events-none rounded-[3px]" />
...
function Container34() {
  return <div className="bg-[rgba(237,232,216,0.04)] flex-[151.336_0_0] min-w-px relative" data-name="Container">
      <div aria-hidden className="absolute border border-[rgba(237,232,216,0.08)] border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col items-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[9.6px] items-center px-[25px] py-[21px] relative size-full">
          <Container35 />
...
function Container37() {
  return <div className="relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[6.4px] items-center relative size-full">
        <Container38 />
        <ContainerMargin />
        <Container40 />
      </div>
...
function Icon2() {
  return <div className="relative shrink-0 size-[13px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="13" preserveAspectRatio="none" viewBox="0 0 13 13" width="13">
        <g id="Icon">
          <path d={svgPaths.p24454500} id="Vector" stroke="var(--stroke-0, #EDE8D8)" strokeWidth="1.08333" />
        </g>
      </svg>
    </div>;
}
...
function Container30() {
  return <div className="content-stretch flex flex-col gap-[32px] h-[253.008px] items-center justify-center relative shrink-0 w-[502px]" data-name="Container">
      <Paragraph16 />
      <Container31 />
      <Container41 />
    </div>;
...
function Container42() {
  return <div className="absolute bg-[rgba(237,232,216,0.07)] h-[253.008px] left-[566px] top-0 w-0" data-name="Container" />;
}
function Container27() {
  return <div className="relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-px items-start relative size-full">
        <Container28 />
        <Container30 />
        <Container42 />
      </div>
...
function Section2() {
  return <div className="bg-[#0a1209] h-[350px] relative shrink-0 w-full" data-name="Section">
      <div aria-hidden className="absolute border-[rgba(237,232,216,0.06)] border-solid border-t inset-0 pointer-events-none" />
      <div className="flex flex-col items-center justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center pt-px px-[56px] relative size-full">
          <Container27 />
        </div>
      </div>
    </div>;
...
function Leaf() {
  return <div className="relative shrink-0 size-[24px]" data-name="leaf">
      <svg className="absolute block inset-0 size-full" fill="none" height="24" preserveAspectRatio="none" viewBox="0 0 24 24" width="24">
        <g id="leaf">
          <path d={svgPaths.p1f220c80} id="Vector" stroke="var(--stroke-0, #F2B138)" strokeLinecap="round" strokeWidth="2" />
        </g>
      </svg>
    </div>;
}
function IconWrapper() {
  return <div className="content-stretch flex flex-col items-center justify-center overflow-clip relative shrink-0 size-[28px]" data-name="Icon-Wrapper">
      <Leaf />
    </div>;
}
function CardGarden() {
  return <div className="bg-white drop-shadow-[0px_4px_6px_rgba(76,110,88,0.05)] flex-[1_0_0] min-w-px relative rounded-[12px]" data-name="Card-Garden">
...
function CookingPot() {
  return <div className="relative shrink-0 size-[24px]" data-name="cooking-pot">
      <svg className="absolute block inset-0 size-full" fill="none" height="24" preserveAspectRatio="none" viewBox="0 0 24 24" width="24">
        <g id="cooking-pot">
          <path d={svgPaths.p3075da00} id="Vector" stroke="var(--stroke-0, #F2B138)" strokeLinecap="round" strokeWidth="2" />
        </g>
      </svg>
    </div>;
}
...
function CardKitchen() {
  return <div className="bg-white drop-shadow-[0px_4px_6px_rgba(76,110,88,0.05)] flex-[1_0_0] min-w-px relative rounded-[12px]" data-name="Card-Kitchen">
      <div aria-hidden className="absolute border border-[#d5dad7] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="content-stretch flex flex-col gap-[16px] items-start p-[32px] relative size-full">
        <IconWrapper1 />
        <p className="[word-break:break-word] font-['DM_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#1c2420] text-[18px] whitespace-nowrap" style={{
...
function Sofa() {
  return <div className="relative shrink-0 size-[24px]" data-name="sofa">
      <svg className="absolute block inset-0 size-full" fill="none" height="24" preserveAspectRatio="none" viewBox="0 0 24 24" width="24">
        <g id="sofa">
          <path d={svgPaths.p2794d100} id="Vector" stroke="var(--stroke-0, #F2B138)" strokeLinecap="round" strokeWidth="2" />
        </g>
      </svg>
    </div>;
}
...
function CardLounge() {
  return <div className="bg-white drop-shadow-[0px_4px_6px_rgba(76,110,88,0.05)] flex-[1_0_0] min-w-px relative rounded-[12px]" data-name="Card-Lounge">
      <div aria-hidden className="absolute border border-[#d5dad7] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="content-stretch flex flex-col gap-[16px] items-start p-[32px] relative size-full">
        <IconWrapper2 />
        <p className="[word-break:break-word] font-['DM_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#1c2420] text-[18px] whitespace-nowrap" style={{
...
function WashingMachine() {
  return <div className="relative shrink-0 size-[24px]" data-name="washing-machine">
      <svg className="absolute block inset-0 size-full" fill="none" height="24" preserveAspectRatio="none" viewBox="0 0 24 24" width="24">
        <g id="washing-machine">
          <path d={svgPaths.pa962300} id="Vector" stroke="var(--stroke-0, #F2B138)" strokeLinecap="round" strokeWidth="2" />
        </g>
      </svg>
    </div>;
}
...
function CardLaundry() {
  return <div className="bg-white drop-shadow-[0px_4px_6px_rgba(76,110,88,0.05)] flex-[1_0_0] min-w-px relative rounded-[12px]" data-name="Card-Laundry">
      <div aria-hidden className="absolute border border-[#d5dad7] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="content-stretch flex flex-col gap-[16px] items-start p-[32px] relative size-full">
        <IconWrapper3 />
        <p className="[word-break:break-word] font-['DM_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#1c2420] text-[18px] whitespace-nowrap" style={{
...
function Globe() {
  return <div className="relative shrink-0 size-[28px]" data-name="globe">
      <svg className="absolute block inset-0 size-full" fill="none" height="28" preserveAspectRatio="none" viewBox="0 0 28 28" width="28">
        <g id="globe">
          <path d={svgPaths.p1cb142c0} id="Vector" stroke="var(--stroke-0, #F2B138)" strokeLinecap="round" strokeWidth="2" />
        </g>
      </svg>
    </div>;
}
function IconWrapper4() {
  return <div className="content-stretch flex flex-col items-center justify-center overflow-clip relative shrink-0 size-[32px]" data-name="Icon-Wrapper">
      <Globe />
    </div>;
}
function CardCommunityText() {
...
function CardCommunity() {
  return <div className="bg-white drop-shadow-[0px_4px_6px_rgba(76,110,88,0.05)] relative rounded-[12px] shrink-0 w-full" data-name="Card-Community">
      <div aria-hidden className="absolute border border-[#d5dad7] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="flex flex-row items-center size-full">
...
function AmenitiesSection() {
  return <div className="bg-[#f2f4f3] relative shrink-0 w-full" data-name="Amenities Section">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start p-[100px] relative size-full">
          <V1Columns />
        </div>
      </div>
    </div>;
...
function Leaf1() {
  return <div className="relative shrink-0 size-[28px]" data-name="leaf">
      <svg className="absolute block inset-0 size-full" fill="none" height="28" preserveAspectRatio="none" viewBox="0 0 28 28" width="28">
        <g id="leaf">
          <path d={svgPaths.pe1d3ff0} id="Vector" stroke="var(--stroke-0, #F2B138)" strokeLinecap="round" strokeWidth="2" />
        </g>
      </svg>
    </div>;
}
...
function CardGarden1() {
  return <div className="flex-[1_0_0] min-w-px opacity-95 relative" data-name="Card-Garden">
      <div aria-hidden className="absolute border border-[#ede8d8] border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex flex-col gap-[16px] items-start p-[32px] relative size-full">
        <IconWrapper5 />
...
function CookingPot1() {
  return <div className="relative shrink-0 size-[28px]" data-name="cooking-pot">
      <svg className="absolute block inset-0 size-full" fill="none" height="28" preserveAspectRatio="none" viewBox="0 0 28 28" width="28">
        <g id="cooking-pot">
          <path d={svgPaths.p33df5c00} id="Vector" stroke="var(--stroke-0, #F2B138)" strokeLinecap="round" strokeWidth="2" />
        </g>
      </svg>
    </div>;
}
...
function CardKitchen1() {
  return <div className="flex-[1_0_0] min-w-px opacity-95 relative" data-name="Card-Kitchen">
      <div aria-hidden className="absolute border border-[#ede8d8] border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex flex-col gap-[16px] items-start p-[32px] relative size-full">
        <IconWrapper6 />
        <p className="[word-break:break-word] font-['DM_Sans:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#ede8d8] text-[18px] whitespace-nowrap" style={{
...
function Sofa1() {
  return <div className="relative shrink-0 size-[28px]" data-name="sofa">
      <svg className="absolute block inset-0 size-full" fill="none" height="28" preserveAspectRatio="none" viewBox="0 0 28 28" width="28">
        <g id="sofa">
          <path d={svgPaths.p428ff60} id="Vector" stroke="var(--stroke-0, #F2B138)" strokeLinecap="round" strokeWidth="2" />
        </g>
      </svg>
    </div>;
}
...
function CardLounge1() {
  return <div className="flex-[1_0_0] min-w-px opacity-95 relative" data-name="Card-Lounge">
      <div aria-hidden className="absolute border border-[#ede8d8] border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex flex-col gap-[16px] items-start p-[32px] relative size-full">
        <IconWrapper7 />
        <p className="[word-break:break-word] font-['DM_Sans:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#ede8d8] text-[18px] whitespace-nowrap" style={{
...
function WashingMachine1() {
  return <div className="relative shrink-0 size-[28px]" data-name="washing-machine">
      <svg className="absolute block inset-0 size-full" fill="none" height="28" preserveAspectRatio="none" viewBox="0 0 28 28" width="28">
        <g id="washing-machine">
          <path d={svgPaths.p3c2ca500} id="Vector" stroke="var(--stroke-0, #F2B138)" strokeLinecap="round" strokeWidth="2" />
        </g>
      </svg>
    </div>;
}
...
function CardLaundry1() {
  return <div className="flex-[1_0_0] min-w-px opacity-95 relative" data-name="Card-Laundry">
      <div aria-hidden className="absolute border border-[#ede8d8] border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex flex-col gap-[16px] items-start p-[32px] relative size-full">
        <IconWrapper8 />
        <p className="[word-break:break-word] font-['DM_Sans:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#ede8d8] text-[18px] whitespace-nowrap" style={{
...
function Globe1() {
  return <div className="relative shrink-0 size-[32px]" data-name="globe">
      <svg className="absolute block inset-0 size-full" fill="none" height="32" preserveAspectRatio="none" viewBox="0 0 32 32" width="32">
        <g id="globe">
          <path d={svgPaths.p34c8c3f0} id="Vector" stroke="var(--stroke-0, #F2B138)" strokeLinecap="round" strokeWidth="2" />
        </g>
      </svg>
    </div>;
}
...
function CardCommunity1() {
  return <div className="opacity-95 relative shrink-0 w-full" data-name="Card-Community">
      <div aria-hidden className="absolute border border-[#ede8d8] border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[24px] items-center p-[32px] relative size-full">
          <IconWrapper9 />
...
function Variation1Root() {
  return <div className="bg-[#131f16] relative shrink-0 w-[1440px]" data-name="Variation-1-Root">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip p-[100px] relative rounded-[inherit] size-full">
        <V1Columns1 />
      </div>
    </div>;
}
...
function Container43() {
  return <div className="absolute content-stretch flex flex-col h-[149.078px] items-start left-[56px] top-[73px] w-[310px]" data-name="Container">
      <Container44 />
      <ParagraphMargin9 />
      <ParagraphMargin10 />
    </div>;
...
function ParagraphMargin12() {
  return <div className="relative shrink-0 w-full" data-name="Paragraph:margin">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[9.6px] relative size-full">
        <Paragraph25 />
      </div>
    </div>;
}
...
function ParagraphMargin14() {
  return <div className="relative shrink-0 w-full" data-name="Paragraph:margin">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start py-[9.6px] relative size-full">
        <Paragraph27 />
      </div>
    </div>;
}
function Container45() {
  return <div className="content-stretch flex flex-col h-[149.078px] items-start relative shrink-0 w-[155px]" data-name="Container">
      <Paragraph23 />
      <ParagraphMargin11 />
      <ParagraphMargin12 />
      <ParagraphMargin13 />
...
function InfoContainers() {
  return <div className="absolute content-stretch flex gap-[48px] items-center left-[852px] top-[73px]" data-name="info containers">
      <Container45 />
      <Container46 />
      <Container47 />
    </div>;
...
function Footer() {
  return <div className="bg-[#0a1209] h-[262.078px] relative shrink-0 w-full" data-name="Footer">
      <div aria-hidden className="absolute border-[rgba(237,232,216,0.06)] border-solid border-t inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container43 />
        <InfoContainers />
...
function ConceptTwo() {
  return <div className="bg-[#0c1a10] h-[2513.778px] relative shrink-0" data-name="ConceptTwo">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Navigation />
        <Section />
        <Section1 />
        ...
        <AmenitiesSection />
        <Variation1Root />
        <div className="aspect-[1774/887] relative shrink-0 w-full" data-name="ChatGPT Image 21 juil. 2026, 22_52_03 1">
          <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 max-w-none object-cover pointer-events-none size-full" src={imgChatGptImage21Juil20262252031} />
        </div>
        <Footer />
      </div>
    </div>;
...
export default function Document() {
  return <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Document">
      <ConceptTwo />
    </div>;
}
