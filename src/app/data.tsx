...
export type AmenityItem = { label: string } & ({ icon: React.ComponentType<{ size?: number; color?: string }> } | { figma: FigmaIcon });

export function AmenityIcon({ item, size, color }: { item: AmenityItem; size: number; color: string }) {
  if ("figma" in item) {
    return (
