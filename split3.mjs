...
if (!homePage || homePage.trim() === '') {
  homePage = getLines('function HomePage(', 'function RutaFloresPage(');
}

let rutaFloresPage = getLines('function RutaFloresPage(', '// ─── Root');
if (!rutaFloresPage || rutaFloresPage.trim() === '') {
    rutaFloresPage = getLines('function RutaFloresPage(', 'export default function App(');
}
